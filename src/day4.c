...
int check_point_x(size_t point[2], char** matrix, size_t width, size_t height)
{
    ...
    for (size_t i = 0; i < 8; i++) {
        ...
        bool is_m = is_inbound(second, width, height) && matrix[second[1]][second[0]] == 'M';
        bool is_a = is_inbound(third, width, height) && matrix[third[1]][third[0]] == 'A';
        bool is_s = is_inbound(fourth, width, height) && matrix[fourth[1]][fourth[0]] == 'S';
...
int check_point_a(size_t point[2], char** matrix, size_t width, size_t height)
{
    ...
    for (int i = 0; i < 4; i++) {
        ...
        bool is_m1 = is_inbound(first, width, height) && matrix[first[1]][first[0]] == 'M';
        bool is_m2 = is_inbound(second, width, height) && matrix[second[1]][second[0]] == 'M';
        bool is_s1 = is_inbound(third, width, height) && matrix[third[1]][third[0]] == 'S';
        bool is_s2 = is_inbound(fourth, width, height) && matrix[fourth[1]][fourth[0]] == 'S';
